...
coordsForOtherObjs=zeros(size(distsToBedsTwoNearestEdges{distComps,distCompsWallCenter},1),4);
...
if l~=size(distsToBedsTwoNearestEdges{distComps,distCompsWallCenter},1)
    disp(size(distsToBedsTwoNearestEdges{distComps,distCompsWallCenter}))
end