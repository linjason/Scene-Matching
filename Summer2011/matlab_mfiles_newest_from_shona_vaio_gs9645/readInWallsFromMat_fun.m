% same as readInWallsFromMat, but can generate distances from any component to the walls of any scene,
% therefore, you can place any component in any scene and generate the distances for that particular scene wall/component combination
% inputs: A matrix, component index in C, C matrix
% outputs: distances in format [xmin xmax ymin ymax]
