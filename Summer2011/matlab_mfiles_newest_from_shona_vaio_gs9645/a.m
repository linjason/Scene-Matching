...
bedIndex=0;
clear newBeds6;
indexIntoIndices=1:2:size(indices, 1);%[1 2 5 6 7 9 11 13 14 18 26 40 41 43 64 71 73 75 76 77 78 81 85 87 88 100 119 130 137];
bb=cell(0,0);
...
parfor i=1:size(C,2)
    ...
    %min(min(scores'))
    if size(find(min(scores')<200000),2)>0
