% maps components from the A arrray to the C array
% for each component in each scene, tells you what its index is in the C array
% key for this map is name of the A array's mat file (11223344.mat)
% the map is called pointerFromAtoC
