function [all_ob_heights, all_ob_heights3, all_ob_heights2, all_ob_heights4] = make_obj_height_map2(results_mat_name, obj_indices)
...
for obj_num=obj_nums
    ...
    for compInd = 2:2:length(A{obj_num})
        ...
        for tri_num = 1:size(tris,2)
            ...
            [tri_voxels vox_minX vox_minY vox_minZ] = triangle_voxelize2(vertices_coords(1,:), vertices_coords(2,:), vertices_coords(3,:));
